...
class Assets {
	...
	public function move_scripts_to_footer() {
		...
		wp_enqueue_script( 'jquery', '/wp-includes/js/jquery/jquery.min.js', array(), ADVANCE_GB_LEARNING_THEME_VERSION, true );
	}
	...
	public function hook_critical_css() {
		...
		$response = wp_remote_get( ADVANCE_GB_LEARNING_BUILD_URI . '/inline.css' );   // load template output in buffer.

		if ( ! is_wp_error( $response ) ) {
			$css = wp_remote_retrieve_body( $response );
			wp_register_style( 'advance-gb-learning-inline-css', false, array(), true, true );
			wp_add_inline_style( 'advance-gb-learning-inline-css', $css );
			wp_enqueue_style( 'advance-gb-learning-inline-css' );
		}
	}
	...
	public function register_styles() {
		...
		// Register styles.
		wp_register_style( 'main-css', ADVANCE_GB_LEARNING_BUILD_URI . '/main.css', array(), filemtime( ADVANCE_GB_LEARNING_BUILD_PATH . '/main.css' ), 'all' );
	...
	public function enqueue_editor_assets() {
		...
		if ( is_admin() ) {
			wp_enqueue_style(
				'advance-gb-learning-editor-css',
				ADVANCE_GB_LEARNING_BUILD_URI . '/geditor.css',
				array(),
				filemtime( ADVANCE_GB_LEARNING_BUILD_PATH . '/geditor.css' ),
				'all'
			);
		}
